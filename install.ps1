...
function Get-ReleaseVersion {
    ...
    Write-Host '  $Version = "4.3.2"; irm https://raw.githubusercontent.com/lbjlaq/Antigravity-Manager/main/install.ps1 | iex' -ForegroundColor Yellow
    return $false
}

function Get-DownloadUrl {
    # NSIS installer: Antigravity.Tools_4.3.2_x64-setup.exe
